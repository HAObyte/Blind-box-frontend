...
export default function AboutUs() {
    ...
    const developmentStories = [
        ...
        },
        {
            type: "fun",
            title: "配色方案大翻车",
            content: "一开始想搞个赛博朋克风，用了荧光绿配紫色，同学说像游戏厅灯箱。后来改成黑金色，本来以为会很高级，结果因为金色调太亮，被老师说像土豪金手机壳...最后调了N次透明度才顺眼。",
            emoji: "😂"
        },
        {
            type: "challenge",
                ...
                <div className="container mx-auto px-4 max-w-3xl">
                    <div className="bg-luxury-black/50 p-6 rounded-xl border border-gold/10">
                        ...
                        <p className="text-white/70 mb-4">
                            这是我的第一个完整Web项目，用React做的盲盒网站。从完全不懂路由、组件，到现在能实现登录、展示商品，花了差不多三周时间。
                        </p>
